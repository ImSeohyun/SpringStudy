		...
		<tr>
			<td>
				<table align="center" width="710" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td rowspan="7"><img src="images/items/${dto.gImage}.gif"
							border="0" align="center" width="300" /></td>
						<td class="td_title">제품코드</td>
						<td class="td_default" colspan="2" style='padding-left: 30px'>${dto.gCode}
						</td>
					</tr>
					<tr>
						<td class="td_title">상품명</td>
						<td class="td_default" colspan="2" style='padding-left: 30px'>${dto.gName}</td>
					</tr>
					<tr>
