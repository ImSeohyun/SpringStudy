		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse">
				<tr>
					...
					<td class="td_default" height="35"> ${orderDTO.userid}</td>
				</tr>
				<tr>
					<td class="td_default" height="35"> 주소</td>
					<td class="td_default" height="35"> (${orderDTO.post})<br>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse">
				...
				<tr>
					...
					<td height="35" class="td_default" align="center">
						<span>${orderDTO.gPrice *orderDTO.gAmount}</span>원
					</td>
				</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse">
				<tr>
					...
					<input type = 'text' id = 'total' value="${orderDTO.gPrice *orderDTO.gAmount}" readonly>원
					</td>
				</tr>
				<tr>
